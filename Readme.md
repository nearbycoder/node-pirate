...
Add `--wide` to human output to preserve full titles and other table values, including custom columns. This can exceed the terminal width; pipe to `less -S` for horizontal scrolling.
