...
program
  ...
  .option("-c, --category <category>", "initial category name, ID, or comma-separated list", "all")
...
program
  ...
  .option("-c, --category <category>", "category name, ID, or comma-separated list (see categories)", "all")
